...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  '/': {
    ...
    '/user/whoami': 'UserController.whoami',
    '/user/getRoles/:name': 'UserController.getRoles',
    '/user/getUserByRole/:name': 'UserController.getUsersByRole',
    'POST /user/setRole': 'UserController.setRoleToUser',
    'POST /user/setUser': 'UserController.setUserRole',
    '/survey/getSurveyCreatedByUser/:username': 'SurveyController.getSurveyCreatedByUser',
